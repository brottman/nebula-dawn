...
static func _build() -> Array[Dictionary]:
	...
	list.append({
		"id": "raptor",
		"name": "Raptor",
		"role": "Interceptor gunship",
		"blurb": "Interceptor frame with a bomb bay bolted on. Dives hard, ends arguments.",
		"cost": 6500,
		"sprite": "res://assets/sprites/player_interceptor.svg",
	...
	list.append({
		...
		"name": "Bulwark",
		"role": "Heavy bastion",
		"blurb": "Aegis-class plating, double shield rig, and the patience to use both.",
		"cost": 10000,
		"sprite": "res://assets/sprites/player_aegis.svg",
	...
	list.append({
		"id": "phantom",
		"name": "Phantom",
		"role": "Cloaked skirmisher",
		"blurb": "Wraith frame refit for silent runs. One shield, one bomb, nothing left to chance.",
		"cost": 15000,
		"sprite": "res://assets/sprites/player_wraith.svg",
